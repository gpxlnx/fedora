...
\begin{longtable}{L!{\VRule}R}
  ...
  & \\
  & \\
  {\bf July 2017--Nov. 2017}\\5 months&{\bf Truebit (Remote)}\\
...
\begin{longtable}{L!{\VRule}R}
  {\bf ERTMS / ETCS DMI Development}& Derived software requirements form the system requirements, effectively splitting them into two components. Designed and implemented the software for the component on the kernel side.\\[5pt]
  & \\
  & \\
  {\bf Safety-critical Hard Real-Time ECU Development}& Wrote the SRS and the SDD for the DSP algorithm. Implemented the DSP algorithm.\\[5pt]
  & \\
  & \\
  {\bf Code Generation}& \begin{itemize}
    \item Wrote A tool that generates binary file (WASM, ELF, ...) parsers in C.
  ...
  & \\
  & \\
  {\bf Defensive Programming and Safety-Aware Software Design}& Studied/Implemented defensive programming practices, coding style and guidelines. Explored the use of FMEA and FTA for the software domain.\\[5pt]
  & \\
  & \\
